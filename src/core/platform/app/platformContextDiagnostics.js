...
export const PLATFORM_CONTEXT_EVENT = Object.freeze({
  ...
  VENUE_HINT_READ: "VENUE_HINT_READ",
  VENUE_HINT_CLEARED: "VENUE_HINT_CLEARED",
  ...
  EXPLICIT_VENUE_SWITCH: "EXPLICIT_VENUE_SWITCH",
  EXPLICIT_CLUSTER_SWITCH: "EXPLICIT_CLUSTER_SWITCH",
});
