...
import { getClubStats, getClubRatings, getClubMembers, getTenantPlayers, getRecentClubActivity } from "../../../features/club/index.js";
import { CLUB_MEMBER_STATUSES } from "../../../features/club/constants/clubMemberRoles.js";

export default function ClubOverviewTab({ club, tenantId }) {
  const stats = useMemo(
  ...
  const recentActivity = useMemo(
    () => getRecentClubActivity(club.id, tenantId, 8),
    [club.id, tenantId]
  );
