...
/** ACT-06 Production candidate scope — Community/Realtime remain blocked. */
export const COMMUNICATION_ACT06_CAPABILITY_STATE = Object.freeze({
  DIRECT_TRUSTED_BACKEND: "DIRECT_TRUSTED_BACKEND",
  SYSTEM_TRUSTED_PRODUCER: "SYSTEM_TRUSTED_PRODUCER",
  CLUB_SELECT_CLIENT_RLS: "CLUB_SELECT_CLIENT_RLS",
  CLUB_WRITE_ADMIN_TRUSTED_BACKEND: "CLUB_WRITE_ADMIN_TRUSTED_BACKEND",
...
export const COMMUNICATION_PROD_SMOKE_MARKER = "COMMS_ACT_07_PROD_SMOKE_";
...
export const COMMUNICATION_TRUSTED_BACKEND_ENV = Object.freeze({
  ...
  /** Exact Owner GO — required before API hosts may bind Production Supabase ref. */
  PRODUCTION_RUNTIME_ENABLE: "COMMS_PRODUCTION_RUNTIME_ENABLE",
  PRODUCTION_RUNTIME_ENABLE_TOKEN:
