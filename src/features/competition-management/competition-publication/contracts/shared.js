/**
 * Shared helpers for CM-06 contracts (pure, deterministic).
...
import { COMPETITION_PUBLICATION_FINGERPRINT_ALGORITHM } from "../constants/comparison.js";
...
export function failContract(code, message, details) {
  throw new CompetitionPublicationError(code, message, details);
}
...
export function stableContentFingerprint(value) {
  ...
  return `${COMPETITION_PUBLICATION_FINGERPRINT_ALGORITHM.prefix}${(hash >>> 0)
    .toString(16)
    .padStart(8, "0")}`;
}
