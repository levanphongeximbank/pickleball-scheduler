/**
 * Shared helpers for CM-01 contracts (pure, deterministic).
 */
...
export function failContract(code, message, details) {
  throw new CompetitionDefinitionError(code, message, details);
}
...
/**
 * Deterministic comparable timestamp (ms since epoch).
 * Timezone ownership is NOT part of CM-01 — callers supply absolute instants.
...
/**
 * Stable lexicographic sort of field paths (deterministic error ordering).
 * @param {string} a
 * @param {string} b
 * @returns {number}
 */
