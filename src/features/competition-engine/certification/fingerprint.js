/**
 * Deterministic helpers for E2E-07 Certification (no Date.now / Math.random).
 */

import { createHash } from "node:crypto";

import { CERTIFICATION_FORBIDDEN_KEYS } from "./constants.js";
 ...
 * @returns {string}
 */
export function computeCertificationFingerprint(value, prefix = "e2e07") {
 ...
 * @returns {unknown}
 */
export function stripForbiddenKeys(value, forbiddenKeys = CERTIFICATION_FORBIDDEN_KEYS) {
