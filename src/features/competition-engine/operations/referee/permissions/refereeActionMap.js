 ...
 *
 * Generic referee operations use competition.referee.* permissions.
 * TEAM_MATCH_RESULT_MANAGE is Team Tournament-specific and must not be
 * required for canonical result submit/correct.
 */
...
export const REFEREE_CAPABILITY = Object.freeze({
  ...
  ASSIGNMENT_MANAGE: "competition.referee.assignment.manage",
  ...
  INCIDENT_REPORT: "competition.referee.incident.report",
});

export const GENERIC_REFEREE_PERMISSIONS = Object.freeze({
  ASSIGNMENT_READ: PERMISSIONS.COMPETITION_REFEREE_ASSIGNMENT_READ,
  ASSIGNMENT_MANAGE: PERMISSIONS.COMPETITION_REFEREE_ASSIGNMENT_MANAGE,
  ASSIGNMENT_ACK: PERMISSIONS.COMPETITION_REFEREE_ASSIGNMENT_ACKNOWLEDGE,
  MATCH_CONTROL: PERMISSIONS.COMPETITION_REFEREE_MATCH_CONTROL,
  SCORE_SUBMIT: PERMISSIONS.COMPETITION_REFEREE_SCORE_SUBMIT,
  RESULT_SUBMIT: PERMISSIONS.COMPETITION_REFEREE_RESULT_SUBMIT,
  RESULT_CORRECT: PERMISSIONS.COMPETITION_REFEREE_RESULT_CORRECT,
  RESULT_READ: PERMISSIONS.COMPETITION_REFEREE_RESULT_READ,
  INCIDENT_REPORT: PERMISSIONS.COMPETITION_REFEREE_INCIDENT_REPORT,
});

export const GENERIC_REFEREE_ROLE_PERMISSIONS = Object.freeze([
 ...
 * @returns {boolean}
 */
export function refereeMapRequiresTeamMatchResultManage(permissions) {
  return (permissions || []).includes(PERMISSIONS.TEAM_MATCH_RESULT_MANAGE);
}
