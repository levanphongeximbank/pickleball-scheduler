/**
 * CORE-14 — pure synchronous SHA-256 (browser + Node safe).
 * Vendored algorithm; no Node crypto module; no package dependency.
 */
...
/**
 * Synchronous SHA-256 lowercase hex over UTF-8 bytes.
 * @param {string} text
 * @returns {string}
 */
export function hashUtf8Sha256Hex(text) {
