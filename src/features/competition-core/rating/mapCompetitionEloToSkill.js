...
/**
 * Map legacy skill decimal (1.0–8.0) to initial competition Elo for backfill/migration.
 * Pure alias — mapping v1 anchor formula.
 *
 * @param {number} legacySkill
 * @param {Object} [options]
 * @returns {number}
 */
export function mapLegacySkillToInitialElo(legacySkill, options = {}) {
  return mapSkillToCompetitionElo(legacySkill, options);
}
