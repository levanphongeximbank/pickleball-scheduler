...
/** Phase 2B.2 — participant contracts, validators, DTOs, mapping interfaces, repository ports. */
export {
  ...
  /** Phase 3B — Participant Resolution Runtime public surface. */
...
export {
  ...
  isJsonSafe,
  cloneJsonSafe,
  /** Phase 3A.2 — Shadow Infrastructure (no Production wiring). */
  SHADOW_REASON_CODE,
  ...
  /** Phase 3A.3 — Integration Bootstrap registries (empty; Integrator-owned). */
...
/** CORE-22 Competition Import / Export */
export {
  CORE22_ENGINE_ID,
  ...
  ID_MAPPING_ACTION,
  // CONFLICT_TYPE omitted: name collision with scheduling CONFLICT_TYPE.
  // Import from `./import-export/index.js` or use IMPORT_EXPORT_CONFLICT_TYPE.
  CONFLICT_TYPE as IMPORT_EXPORT_CONFLICT_TYPE,
