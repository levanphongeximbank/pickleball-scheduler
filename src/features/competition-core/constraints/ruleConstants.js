...
export const RULE_ERROR_CODE = Object.freeze({
  ...
  PREFER_OPPONENT_MISSED: "prefer_opponent_missed",
  MUST_OPPONENT_UNSATISFIED: "must_opponent_unsatisfied",
  MUST_NOT_OPPONENT_VIOLATED: "must_not_opponent_violated",
  SAME_GROUP_VIOLATED: "same_group_violated",
  DIFFERENT_GROUP_VIOLATED: "different_group_violated",
  SAME_TEAM_VIOLATED: "same_team_violated",
  DIFFERENT_TEAM_VIOLATED: "different_team_violated",
  MIN_PARTNER_REPEAT_UNSATISFIED: "min_partner_repeat_unsatisfied",
  MIN_OPPONENT_REPEAT_UNSATISFIED: "min_opponent_repeat_unsatisfied",
  UNSUPPORTED_CONSTRAINT_EVALUATION: "unsupported_constraint_evaluation",
...
export const RULE_SOFT_SCORE = Object.freeze({
  ...
  preferOpponentMatchBonus: 110,
  preferOpponentMissPenalty: 35,
  ...
  sameGroupBonus: 90,
  sameGroupMissPenalty: 30,
  differentGroupViolationPenalty: 160,
  sameTeamBonus: 120,
  sameTeamMissPenalty: 40,
  differentTeamViolationPenalty: 200,
  skillCapOverPenaltyPerStep: 20,
  teamSkillDiffPenaltyPerStep: 25,
  maxPartnerRepeatPenalty: 150,
  maxOpponentRepeatPenalty: 120,
  minPartnerRepeatMissPenalty: 140,
  minOpponentRepeatMissPenalty: 110,
