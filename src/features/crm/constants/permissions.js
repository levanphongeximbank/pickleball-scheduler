...
export const CRM_PERMISSIONS = Object.freeze({
  ...
  TAG_VIEW: "crm.tag.view",
  TAG_UPDATE: "crm.tag.update",
  TAG_ASSIGN: "crm.tag.assign",
  CONSENT_CREATE: "crm.consent.create",
  CONSENT_VIEW: "crm.consent.view",
  CONSENT_REVOKE: "crm.consent.revoke",
