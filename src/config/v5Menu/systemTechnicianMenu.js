...
export const SYSTEM_TECHNICIAN_MENU_ROOT = menuFolder({
  ...
  children: [
    ...
    // Batch 1B: keep /players + VPR here — SYSTEM_TECHNICIAN has no customers/dashboard groups.
    menuLeaf({
      key: "tech-players",
      icon: "players",
      text: "Vận động viên",
    ...
    // Batch 1B: /support stays under Hỗ trợ hub (SUPPORT group) — no tech-zone duplicate.
    menuLeaf({
