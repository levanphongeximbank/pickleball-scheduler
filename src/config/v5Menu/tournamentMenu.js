...
export const TOURNAMENT_MENU_ROOT = menuFolder({
  ...
  children: [
    menuLeaf({
      key: "tournament-overview-player",
      icon: "dashboard",
      text: "Tổng quan",
    ...
    menuLeaf({
      key: "tournament-my-dashboards-player",
      icon: "tournament-list",
      text: "Giải của tôi",
      ...
      roles: [ROLES.PLAYER],
      featureStatus: FEATURE_STATUS.LIVE,
      featureNote: "Authenticated My Tournaments hub — Dashboard discoverability",
    }),
    menuLeaf({
      key: "tournament-list-player",
      icon: "tournament-list",
      text: "Danh sách giải",
