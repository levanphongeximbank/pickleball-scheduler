...
const SHELL_FLAT_MENU_KEYS_BY_ROLE = Object.freeze({
  ...
  [ROLES.TEAM_CAPTAIN]: ["captain-home", "captain-schedule", "captain-lineup", "captain-results", "captain-messages"],
  [ROLES.REFEREE]: ["referee-hub", "profile", "mobile-notifications"],
  [ROLES.SYSTEM_TECHNICIAN]: ["tech-overview", "tech-tenants", "tech-users", "tech-integrations", "support-hub"],
});
