-- PLATFORM-HARD-CUTOVER staging package copy of docs/v5/PHASE_36_COURT_CLUSTER_CLOUD_SYNC.sql
-- TARGET ONLY: qyewbxjsiiyufanzcjcq — Owner GO required before apply. Do not apply to Production.
-- Phase 36 — Court cluster cloud sync (admin upsert + remove owner)
-- Dependency for auth gate: can_review_court_claim() from PHASE_33 (file 10 in this package).
