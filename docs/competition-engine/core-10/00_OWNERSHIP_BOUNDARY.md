...
**Protected:** root `competition-core/index.js` (Integrator-owned; Phase 1B / 1C-A / 1C-B1 / 1C-B2-A / 1C-B2-B / 1C-C / 1D / 1E do not modify it)
...
Phase 1C-B2-A / 1C-B2-B / 1C-C / 1D / 1E likewise do **not** import CORE-01 private implementations and do **not** ship a CORE-01 adapter.
