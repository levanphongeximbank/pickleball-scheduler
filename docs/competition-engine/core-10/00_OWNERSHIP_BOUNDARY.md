...
**Protected:** root `competition-core/index.js` (Integrator-owned; Phase 1B / 1C-A / 1C-B1 / 1C-B2-A / 1C-B2-B do not modify it)
...
Phase 1C-B2-B does **not** own final evaluation-result fingerprint certification (Phase 1C-C), candidate ranking across a search frontier, search solvers, or CORE-01 adapters.
...
Phase 1C-B2-A / 1C-B2-B likewise do **not** import CORE-01 private implementations and do **not** ship a CORE-01 adapter.
