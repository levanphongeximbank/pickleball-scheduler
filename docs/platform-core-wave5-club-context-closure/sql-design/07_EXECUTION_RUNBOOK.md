...
Therefore Q1 (committed REVOKE) + drain proof are mandatory **before** APPLY starts.
...
`07D` grants the **intended Wave 5 public command surface** (explicit signatures). Internal helpers stay `authenticated EXECUTE = DENIED`.
