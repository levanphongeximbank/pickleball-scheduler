...
| `phase42_can_transfer_president` | `(text)` | EXISTING_FUNCTION_EXPECTED_CERTIFIED_BODY | ABORT | ABORT | PREDECESSOR_SET=`24f9f7e47c2dc0a166c6385811f6c43d`,`14b3e8e88cc83b1824e3631d718b89e5` TARGET=`61dd0458b9240d5407394f6f8d492bf0` owner=`postgres` vol=`s` lang=`sql` | CERTIFIED_MATCH |
...
| `club_review_membership_request` | `(uuid, uuid, text, text, integer)` | EXISTING_FUNCTION_EXPECTED_CERTIFIED_BODY | ABORT | ABORT | PREDECESSOR_SET=`0b8ee11ef23090f8cd6e364ad2e6eb60`,`cd904d71c508e9ee1e4768396c515ab0` TARGET=`2ef9e0d87071bba93814ab20344539c1` owner=`postgres` vol=`v` lang=`plpgsql` | CERTIFIED_MATCH |
