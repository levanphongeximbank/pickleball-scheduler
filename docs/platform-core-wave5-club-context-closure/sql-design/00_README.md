...
| `08C_PRODUCTION_PREDECESSOR_VARIANT_AND_AUTHZ_LOCK.md` | documentation | Production predecessor SET + Wave4 transfer-president authz lock (retire profiles Venue-role fallback) |
