...
| NEWS-02 — Durable Persistence, SQL, RLS & Editorial Authorization | Authored — SQL **NOT APPLIED** |
| NEWS-03 — Staging Apply & Live Public Read Integration | Seed + Staging harness authored — **awaiting Owner GO** (SQL not applied) |
...
Permission seed + Staging harness (NEWS-03): `docs/news-public-content/news-03/` + `scripts/news/news-03-staging-rollout.mjs`
