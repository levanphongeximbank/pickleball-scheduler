...
5. Production actor membership backfill **only** from an Owner-approved user_id → tenant_id → role_code manifest. Do **not** derive membership from profile role. Players/Referees/Club/Coach are not automatic members.
