-- =============================================================================
-- OPERATION B1B — Database environment binding (PRODUCTION)
...
--   project_ref           = expuvcohlcjzvrrauvud
--
...
-- Conflicting Staging binding: FAIL CLOSED (no silent UPDATE).
-- =============================================================================
...
BEGIN
  ...
  RAISE EXCEPTION
    'OPERATION_B1B_ENVIRONMENT_BINDING_CONFLICT: existing mode=% ref=% cannot be replaced by production/expuvcohlcjzvrrauvud',
    v_mode,
    v_ref;
END
$install$;
