-- Phase 40 — Fix club_upsert_registry COALESCE json/jsonb mismatch
-- Error: COALESCE could not convert type jsonb to json
-- Cause: p_club is json; p_club -> key returns json; '[]'::jsonb is jsonb
...
begin
  ...
  -- Cast json extracts to jsonb before COALESCE (fixes jsonb/json type mismatch)
