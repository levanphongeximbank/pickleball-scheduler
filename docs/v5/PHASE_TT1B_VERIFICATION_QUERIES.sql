-- Phase TT-1B — Structured verification queries (read-only, idempotent)
-- Run AFTER docs/v5/PHASE_TT1B_TEAM_TOURNAMENT_SSOT.sql
-- STAGING / PREVIEW ONLY — NOT Production
--
-- Each row: check_id | expected | actual | status (PASS|FAIL)
...
-- ═══════════════════════════════════════════════════════════════════
-- V2 — TT-1B tables (all 5 required)
-- ═══════════════════════════════════════════════════════════════════
tt1b_expected as (
  select unnest(array[
...
-- ═══════════════════════════════════════════════════════════════════
-- V4 — Idempotency unique constraints (exact column lists)
-- ═══════════════════════════════════════════════════════════════════
constraint_cols as (
  select
...
-- ═══════════════════════════════════════════════════════════════════
-- V5 — RPC contracts (Phase 23C vs TT-1B overloads)
-- ═══════════════════════════════════════════════════════════════════
fn_meta as (
  select
...
-- ═══════════════════════════════════════════════════════════════════
-- V6 — Existing version data per table
-- ═══════════════════════════════════════════════════════════════════
version_bounds as (
...
-- ═══════════════════════════════════════════════════════════════════
-- Extra — command log, payload hash, active lineup, FKs, indexes
-- ═══════════════════════════════════════════════════════════════════
extra as (
  select
