...
--
-- Extends team_tournament_get_captain_portal with viewer-safe Dreambreaker
-- projection from public.team_tournament_dreambreaker_states.
-- Own order IDs only. Opponent order is a boolean. No get_setup exposure.
-- Preserves published subMatches support. Signature unchanged.
-- ═══════════════════════════════════════════════════════════════════
...
comment on function public.team_tournament_get_captain_portal(text, integer) is
  'Scoped captain portal reader. Published subMatches + viewer-safe Dreambreaker (ownOrder only).';
