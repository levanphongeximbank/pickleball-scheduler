...
--
-- Restores team_tournament_get_captain_portal to the pre-rosterAthletes
-- contract (playerIds only) from captain-access-control-01.
-- Does NOT alter profiles RLS.
-- ═══════════════════════════════════════════════════════════════════
