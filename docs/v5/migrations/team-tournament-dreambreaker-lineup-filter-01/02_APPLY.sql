...
--
-- Hardens public.team_tournament_validate_lineup_selections only:
--   skip activation-only Dreambreaker catalog rows
--   (discipline_kind='dreambreaker' OR activation_rule='tie_at_2_2')
-- Ordinary lineup playerCount / gender / MLP participation unchanged.
