...
-- ---------------------------------------------------------------------------
-- club_create
-- Canonical implementation: docs/v5/PHASE_42G_CLUB_CREATE_OWNER.sql
-- Athlete/PLAYER with club.create → active member + club_owner (+ president).
-- Super Admin does NOT auto-become member/owner/president.
-- Never writes profiles.club_id; never changes platform role.
-- ---------------------------------------------------------------------------
-- (Body replaced by Phase 42G — keep grant for reference)
