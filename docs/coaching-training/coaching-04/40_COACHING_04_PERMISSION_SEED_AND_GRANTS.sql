-- =============================================================================
-- COACHING-04 — Permission seed + COACH/PLAYER role grants (CANONICAL)
-- Purpose: Seed assigned.* (COACH) + coaching.self.read (PLAYER) and grant when
--          roles exist. Does NOT modify admin grants.
-- Status: CANONICAL — promoted from proposal for blank-DB rebuild readiness (B-R10). Apply only under Owner GO for a named environment.
--
-- Explicit:
