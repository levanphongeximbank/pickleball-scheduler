...
**Canonical baseline:** `origin/main@9360fcc9` (PR #360 merged)
...
| Supabase advisor findings | `OPEN_BLOCKER` | CRITICAL | Two target Security Definer View ERRORs cleared; observed security count 516 → 514. Six ERROR public tables without RLS and remaining privileged-function findings persist | Triage remaining ERROR and privileged-function exposure; bind remediation/defer decisions to exact objects and evidence |
...
| Staging Security Invoker / anon exposure | `CLOSED_WITH_EVIDENCE` | HIGH | PRs #358–#360; migrations `20260804031702` and `20260804041304`; authenticated A/B PASS; anon read 0, INSERT denied, UPDATE 0; cleanup 0/0 | Preserve exact migration order, rollback, and evidence |
