...
const TABLE_PROBES = [
  ...
  { table: "court_engine_stores", mode: "tenant", tenantColumn: "tenant_id" },
  { table: "court_engine_active_sessions", mode: "tenant", tenantColumn: "tenant_id" },
  { table: "court_clusters", mode: "tenant", tenantColumn: "venue_id" },
  { table: "user_cluster_assignments", mode: "blocked-empty", tenantColumn: "user_id" },
