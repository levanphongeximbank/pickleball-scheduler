...
const ROUTES = [
  {
    ...
    mustSee: "Trung tâm giải đấu",
  },
  {
    id: "SCREEN_02",
    path: "/ux-prototype/tournament-experience/t/pick-vn-open-2026",
    mustSee: "Tổng quan",
  },
  {
    id: "SCREEN_04",
    path: "/ux-prototype/tournament-experience/t/pick-vn-open-2026/registration",
    mustSee: "Đăng ký & Công bố",
  },
];
const VIEWPORTS = [
...
for (const route of ROUTES) {
  for (const vp of VIEWPORTS) {
    ...
    const headerPass = !isMobile || metrics.headerStable;
    const renderPass =
