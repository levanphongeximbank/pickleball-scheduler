...
const ROUTES = [
  { id: "SCREEN_15", path: "/ux-prototype/tournament-experience/t/pick-vn-open-2026/director", mustSee: "Diễn biến vận hành" },
  { id: "SCREEN_16", path: "/ux-prototype/tournament-experience/t/pick-vn-open-2026/courts", mustSee: "12 sân vật lý" },
  { id: "SCREEN_17", path: "/ux-prototype/tournament-experience/t/pick-vn-open-2026/referees", mustSee: "Bảng phân công trọng tài" },
  { id: "SCREEN_18", path: "/ux-prototype/tournament-experience/t/pick-vn-open-2026/exceptions", mustSee: "Danh sách sự cố" },
  { id: "SCREEN_19", path: "/ux-prototype/tournament-experience/t/pick-vn-open-2026/communications", mustSee: "Lịch sử gửi" },
];
const VIEWPORTS = [
